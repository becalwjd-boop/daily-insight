...
Google Play Store 등록 정보(아이콘, 스크린샷, Feature Graphic, 앱 설명)는 서비스 변경 사항에 맞추어 함께 관리합니다.

사용자 확보 이후 광고 시스템(애드센스)을 단계적으로 적용하는 것을 운영 정책으로 합니다.
