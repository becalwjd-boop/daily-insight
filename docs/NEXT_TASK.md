...
| -------- | ------------------------------------- |
| High   | Google Play 비공개 테스트 진행 |
| High   | 메인 페이지 로딩 속도 개선 |
| High   | 부동산 관련도 추가 튜닝 |
| Medium | Google Play 프로덕션 출시 준비 |
| Medium | BigKinds 기반 Archive 구축 |
| Medium | 사용자 경험(UX) 개선 |
